    ...
    <main className="gradient-bg min-h-screen flex flex-col items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-xl p-8 max-w-md w-full text-center">
        ...
        <div className="flex justify-center mb-4">
          <div className="bg-green-100 text-green-600 text-sm px-4 py-1 rounded-full font-medium flex items-center">
        ...
        <p className="text-gray-600 mb-8">
          Agradecemos por escolher o <span className="font-semibold text-green-600">Plano Zap Essencial</span>. 
          Você está a um passo de começar a receber oportunidades de licitações diretamente no seu WhatsApp.
        </p>
        
        <p className="text-sm text-gray-500 mb-8">
          Agora você precisa cadastrar suas <strong>3 palavras-chave</strong> e seu número de WhatsApp 
