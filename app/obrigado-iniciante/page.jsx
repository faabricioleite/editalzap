    ...
    if (typeof window !== 'undefined') {
      ...
      const checkFbq = setInterval(() => {
        if (typeof window.fbq === 'function') {
          ...
          window.fbq('track', 'Purchase', {
            currency: 'BRL',
            value: 20.00,
            content_name: 'Zap Iniciante',
            content_type: 'product',
            content_ids: ['zap-iniciante'],
          });
          
          console.log('[Meta Pixel] Evento Purchase disparado para o plano Zap Iniciante');
      ...
      const checkSendEvent = setInterval(() => {
        if (typeof window.sendFBEvent === 'function') {
          ...
          console.log('[Meta Conversion API] Evento Purchase disparado para o plano Zap Iniciante');
    ...
    <main className="gradient-bg min-h-screen flex flex-col items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-xl p-8 max-w-md w-full text-center">
        ...
        <p className="text-gray-600 mb-8">
          Agradecemos por escolher o <span className="font-semibold text-green-600">Plano Zap Iniciante</span>. 
          Você está a um passo de começar a receber oportunidades de licitações diretamente no seu WhatsApp.
        </p>
        
        <p className="text-sm text-gray-500 mb-8">
          Agora você precisa cadastrar suas palavras-chave e seu número de WhatsApp 
